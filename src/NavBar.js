...
const NavBar =() =>{
    ...
    return(
        ...
        <Flex justify="center" width="100%"align="center"   justifyContent="center"  paddingTop="1rem">
            ...
            <Link className='link' to="Education" spy={true} smooth={true} offset={30} duration={500}margin="0 5px">Education</Link>
            <Link className='link' to="Work" spy={true} smooth={true} offset={30} duration={500}margin="0 5px">Work Experience</Link>
            </ul>
            </div>
           </Flex>
        </Flex>
